...
# -*- coding: utf-8 -*-
"""
Created on Thu Apr 18 15:12:01 2019
...
if __name__ == '__main__':
    ...
    locationPlots = 'CNN_plots_galaxy_subclasses/'
    ...
    # exclude stars
    gal_indexes = (y[0] == 'GALAXY')
    y = y[gal_indexes]
    X = X[gal_indexes]
    y = np.array(y[1].astype(str))
    # add info for missing values
    y[y=='                     '] = 'Not Assigned'
